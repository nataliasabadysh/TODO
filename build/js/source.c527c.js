...
module.exports = {"task":"styles-m__task---1a0vR","content":"styles-m__content---1hPF0","toggleTaskCompletedState":"styles-m__toggleTaskCompletedState---2L2l-","actions":"styles-m__actions---2skzN","toggleTaskFavoriteState":"styles-m__toggleTaskFavoriteState---ebjYx","updateTaskMessageOnClick":"styles-m__updateTaskMessageOnClick---MxeXx","completed":"styles-m__completed---3sU5F"};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return withSvg; });
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
// Core
...
const decorateSvg = ({
  ...
  class withSvg extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(...args) {
      super(...args);
      this.state = {
        hover: false,
    ...
    render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Enhanceable, enhanceableProps)));
    }
  ...
  withSvg.displayName = `withSvg(${Object(___WEBPACK_IMPORTED_MODULE_2__[/* getDisplayName */ "a"])(Enhanceable)})`;
  return withSvg;
};
...
var immutable_es = __webpack_require__(3);

// CONCATENATED MODULE: ./source/app/instruments/helpers.js
// Core
...
const sortTasksByDate = tasks => {
  return tasks.sort((task1, task2) => {
    if (moment_default()(task1.get('created')).unix() < moment_default()(task2.get('created')).unix()) {
      return 1;
    } else if (moment_default()(task1.get('created')).unix() > moment_default()(task2.get('created')).unix()) {
      return -1;
    }
...
const sortTasksByGroup = tasks => {
  ...
  return Object(immutable_es["a" /* List */])([...sortTasksByDate(favorite), ...sortTasksByDate(usual), ...sortedCompleted]);
};
// CONCATENATED MODULE: ./source/app/instruments/index.js
/* concated harmony reexport getDisplayName */__webpack_require__.d(__webpack_exports__, "a", function() { return getDisplayName; });
/* unused concated harmony import sortTasksByDate */
/* concated harmony reexport sortTasksByGroup */__webpack_require__.d(__webpack_exports__, "b", function() { return sortTasksByGroup; });
/* unused concated harmony import BaseTaskModel */
...
// extracted by mini-css-extract-plugin
module.exports = {"scheduler":"styles-m__scheduler---1eZho","completeAllTasks":"styles-m__completeAllTasks---1jiK3"};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _instruments_withSvg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
// Core
 // Instruments
...
class Checkbox extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("g", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("rect", {
      fill: fill,
      height: "25",
      rx: "5",
      ry: "5",
...
/* harmony default export */ __webpack_exports__["a"] = (Object(_instruments_withSvg__WEBPACK_IMPORTED_MODULE_1__[/* withSvg */ "a"])({
  viewBoxWidth: 27,
  viewBoxHeight: 27,
  width: 25,
  height: 25
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Scheduler; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_flip_move__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(uuid__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3);
/* harmony import */ var _styles_m_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
/* harmony import */ var _styles_m_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_styles_m_css__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _theme_assets_Checkbox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
/* harmony import */ var _tasks_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
var _tasks_json__WEBPACK_IMPORTED_MODULE_7___namespace = /*#__PURE__*/__webpack_require__.t(16, 1);
/* harmony import */ var _instruments__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6);
/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20);
...
let Scheduler = (_dec = Object(react_hot_loader__WEBPACK_IMPORTED_MODULE_2__["hot"])(module), _dec(_class = (_temp = class Scheduler extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    super(...args);
    this.state = {
      newTaskMessage: '',
      tasksFilter: '',
      tasks: Object(immutable__WEBPACK_IMPORTED_MODULE_4__[/* fromJS */ "c"])(_tasks_json__WEBPACK_IMPORTED_MODULE_7__)
    };
    ...
    this._getAllCompleted = () => this.state.tasks.every(task => task.get('completed'));

    this._createTask = event => {
      ...
      const newTask = Object(immutable__WEBPACK_IMPORTED_MODULE_4__[/* Map */ "b"])({
      ...
      this.setState(({
        ...
        tasks: Object(_instruments__WEBPACK_IMPORTED_MODULE_8__[/* sortTasksByGroup */ "b"])(tasks.unshift(newTask)),
        newTaskMessage: ''
      }));
    };
    ...
    this._updateTask = updatedTask => {
      this.setState(({
        ...
        const indexToReplace = tasks.findIndex(task => task.get('id') === updatedTask.id);
        return {
          tasks: Object(_instruments__WEBPACK_IMPORTED_MODULE_8__[/* sortTasksByGroup */ "b"])(tasks.update(indexToReplace, () => Object(immutable__WEBPACK_IMPORTED_MODULE_4__[/* Map */ "b"])(updatedTask)))
        };
      });
    };
  ...
  render() {
    ...
    const todoList = tasks.filter(task => task.get('message').toLowerCase().includes(tasksFilter)).map(task => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Task__WEBPACK_IMPORTED_MODULE_9__[/* Task */ "a"], _extends({
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
      className: _styles_m_css__WEBPACK_IMPORTED_MODULE_5___default.a.scheduler
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("main", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "\u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
      placeholder: "\u041F\u043E\u0438\u0441\u043A",
      type: "search",
      value: tasksFilter,
      ...
      className: _styles_m_css__WEBPACK_IMPORTED_MODULE_5___default.a.createTask,
      maxLength: 50,
      placeholder: "\u041E\u043F\u0438\u0441a\u043D\u0438\u0435 \u043C\u043E\u0435\u0439 \u043D\u043E\u0432\u043E\u0439 \u0437\u0430\u0434\u0430\u0447\u0438",
      type: "text",
      value: newTaskMessage,
      onChange: this._updateNewTaskMessage
    }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: _styles_m_css__WEBPACK_IMPORTED_MODULE_5___default.a.overlay
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_flip_move__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
      duration: 400,
      easing: "ease-in-out"
    }, todoList)))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("footer", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_theme_assets_Checkbox__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
      checked: allCompleted,
      color1: "#363636",
      color2: "#fff",
      onClick: this._completeAllTasks
    }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: _styles_m_css__WEBPACK_IMPORTED_MODULE_5___default.a.completeAllTasks
...
module.exports = [{"id":"xjh","message":"🎓 Успешно пройти React-интенсив компании Lectrum","completed":false,"favorite":true},{"id":"xjr","message":"🕶 Взять автограф у Джареда Лето","completed":false,"favorite":false},{"id":"xrh","message":"👵🏽 Зарегистрировать бабушку в Твиче","completed":false,"favorite":false},{"id":"rjh","message":"🐩 Записать собаку на груминг","completed":false,"favorite":false},{"id":"xph","message":"🥁 Научиться играть на барабанах","completed":true,"favorite":false}];
...
/* harmony default export */ __webpack_exports__["a"] = (enhancedFlipMove);
...
// EXTERNAL MODULE: ./source/app/components/Task/styles.m.css
var styles_m = __webpack_require__(1);
var styles_m_default = /*#__PURE__*/__webpack_require__.n(styles_m);

// EXTERNAL MODULE: ./source/app/theme/assets/Checkbox.js
var Checkbox = __webpack_require__(8);

// EXTERNAL MODULE: ./source/app/instruments/withSvg.js
var withSvg = __webpack_require__(2);

// CONCATENATED MODULE: ./source/app/theme/assets/Remove.js
// Core
 // Instruments
...
/* harmony default export */ var assets_Remove = (Object(withSvg["a" /* withSvg */])({
  viewBoxWidth: 53.8,
  viewBoxHeight: 53.8,
  width: 17,
  height: 17
})(Remove_Remove));
// CONCATENATED MODULE: ./source/app/theme/assets/Edit.js
// Core
 // Instruments
...
/* harmony default export */ var assets_Edit = (Object(withSvg["a" /* withSvg */])({
  viewBoxWidth: 21,
  viewBoxHeight: 21,
  width: 19,
  height: 19
})(Edit_Edit));
// CONCATENATED MODULE: ./source/app/theme/assets/Star.js
// Core
 // Instruments
...
/* harmony default export */ var assets_Star = (Object(withSvg["a" /* withSvg */])({
  viewBoxWidth: 90,
  viewBoxHeight: 85.8,
  width: 19,
  height: 19
})(Star_Star));
// CONCATENATED MODULE: ./source/app/components/Task/index.js
...
class Task_Task extends react["PureComponent"] {
  constructor(...args) {
    ...
    this._updateTask = () => {
      ...
      _updateTask(this._getTaskShape({
        message: newMessage
      }));
  ...
  render() {
    ...
    const styles = classnames_default()(styles_m_default.a.task, {
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(10),ba=__webpack_require__(23);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
// EXTERNAL MODULE: ./source/app/components/Scheduler/index.js
var Scheduler = __webpack_require__(14);

// CONCATENATED MODULE: ./source/app/index.js
// Core
